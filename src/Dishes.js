      ...
      <div>
        <div>
          ...
          <div>
            ...
            <p>
              To prepare a Rinderbraten you will need some high quality piece of
              beef and a lot of time.
            </p>
            <p>
              The meat is put in the oven and cooked slowly in its juices for
              hours and hours.
            </p>
            <p>
            ...
            <p>
              Traditionally Spätzle are a great side dish for Rinderbraten as
              the perfectly soak up all the juices and the sauce to add for even
              more flavour.
            </p>{" "}
          </div>
        </div>{" "}
